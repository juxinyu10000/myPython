...
def concurrency_test():
    ...
    loans = pd.read_csv("./loan2007_2015.csv")
...
if __name__ == '__main__':
    ...
    thread.start_new_thread(concurrency_test, ('th1', 1))
    thread.start_new_thread(concurrency_test, ('th1', 2))
    thread.start_new_thread(concurrency_test, ('th1', 3))
